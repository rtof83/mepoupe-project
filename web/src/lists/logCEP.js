          ...
          <Table sx={{ minWidth: 800 }} aria-label="customized table">
              ...
              { data && Object.keys(data).map((item) => (
                  <StyledTableRow key={0}>
                    ...
                    <StyledTableCell align="center">{data[item].cep}</StyledTableCell>
                    <StyledTableCell align="left">{data[item].log}</StyledTableCell>
                    <StyledTableCell align="center">{data[item].uf}</StyledTableCell>
